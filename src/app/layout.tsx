  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Google Analytics */}
        <Script 
          src="https://www.googletagmanager.com/gtag/js?id=G-GLY6PVFCD8" 
      ...
      <body className={`${inter.className} antialiased`}>
        ...
        {/* Firebase */}
        <Script id="firebase-sdk" src="https://www.gstatic.com/firebasejs/10.12.5/firebase-app.js" strategy="afterInteractive" />
        <Script id="firebase-analytics" src="https://www.gstatic.com/firebasejs/10.12.5/firebase-analytics.js" strategy="afterInteractive" />
