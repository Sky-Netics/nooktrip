...
const ItinerarySummeryCard = memo(function ItinerarySummeryCard({ itinerary }: Props) {
  return (
...
ItinerarySummeryCard.displayName = 'ItinerarySummeryCard';

export default ItinerarySummeryCard;
